...
tab1, tab2, tab3, tab4 = st.tabs(['Publisher and copyright statements', 'Rights retention statement', 'Grey literature citation generator', 'Title organiser'])
...
with tab4:
    ...
    def decapitalize_title(title):
        words = title.split()
        decapitalized_words = [words[0]] + [word.lower() for word in words[1:]]
        return ' '.join(decapitalized_words)
