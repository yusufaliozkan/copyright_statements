...
with tab3:
    ...
    st.subheader('(Grey literature)[https://library.leeds.ac.uk/info/1110/resource_guides/7/grey_literature] citation generator:')
    st.write('You can generate your citation by filling the boxes below.')
