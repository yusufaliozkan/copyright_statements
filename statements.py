...
with tab1:
    ...
    with st.expander('All publisher statements'):        
        st.write('This page lists all the copyright statements as a dataset. You can copy or download all the datasets. The dataset updated on ' + st.date_input(datetime.datetime(2019, 7, 6)))
        st.dataframe(df_new)
